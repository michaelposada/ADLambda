...
make
make install
export `PKG_CONFIG_PATH=${PKG_CONFIG_PATH}:/epics/support/areaDetector/ADLambda/LambdaSupport/libfsdetcore-linux-x86_64/lib/pkgconfig`
cd ..

export `LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:/epics/support/areaDetector/ADLambda/LambdaSupport/libfsdetcore-linux-x86_64/lib`
...
make
make install
export `PKG_CONFIG_PATH=${PKG_CONFIG_PATH}:/epics/support/areaDetector/ADLambda/LambdaSupport/liblambda-linux-x86_64/lib/pkgconfig`
cd ..
